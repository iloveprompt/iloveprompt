...
const FeatureCard: React.FC<FeatureCardProps> = ({ 
  ...
  return (
    <Card className={`slide-in ${delay} group relative bg-darkBg/80 backdrop-blur-md rounded-xl border border-electricBlue/20 hover:border-neonPurple transition-all duration-300 shadow-lg hover:shadow-neonPurple/20`}>
      <CardContent className="p-6">
        ...
        <p className="text-base text-pureWhite/90">{description}</p> {/* Alterado para pureWhite com leve opacidade */}
      </CardContent>
    </Card>
  );
};
