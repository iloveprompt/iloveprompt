...
const DatabaseSetupPage: React.FC = () => {
  ...
  useEffect(() => {
    if (user) {
      // Aqui você pode adicionar sua lógica para verificar se o usuário é administrador
      // Por exemplo, verificar um campo específico nos metadados do usuário
      const userEmail = user.email;
      // Apenas para exemplo, considere um administrador específico
      setIsAdmin(true); // Definir como true para teste
    }
  }, [user]);
