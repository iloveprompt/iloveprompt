        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="mt-16 bg-darkBg/50 p-6 rounded-xl border border-electricBlue/20 backdrop-blur-md shadow-xl">
            ...
            <div className="flex flex-wrap justify-center gap-6 items-center">
              <a href="https://lovable.dev/" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/1afc2e55-681b-40b7-9384-7675460432fe.png" alt="Lovable" className="h-6 w-auto" />
                      </a>
                      <a href="https://app.tempolabs.ai/" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/72419187-c10f-411e-ba5a-301f61f4df3b.png" alt="Tempo Labs" className="h-6 w-auto" />
                      </a>
                      ...
                      <a href="https://bolt.new/" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/84e62910-ce56-4fdb-89dd-67a95a1e2c9c.png" alt="MGX" className="h-6 w-auto" />
                      </a>
                      <a href="https://replit.com/" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/e7e6d8b7-b83c-4b6f-9ea2-e78b57be4d5f.png" alt="Replit" className="h-6 w-auto" />
                      </a>
                      <a href="https://v0.dev/" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/23ab6142-d115-41c6-b4c1-f85407e0007f.png" alt="V0" className="h-6 w-auto" />
                      </a>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-b from-darkBg/70 to-neonPurple/10 p-6 rounded-xl border border-neonPurple/20 hover:border-aquaGreen transition-all duration-300 group shadow-xl hover:shadow-aquaGreen/40 hover-glow">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-neonPurple/10 flex items-center justify-center mr-4 border border-neonPurple/20 backdrop-blur-sm">
                  <img alt="User avatar" src="/lovable-uploads/3ad3c8f3-8cd6-4c69-a2c5-bda3dacb16aa.png" className="w-full h-full rounded-full object-cover" />
                </div>
                <div>
            ...
            <div className="bg-gradient-to-b from-darkBg/70 to-aquaGreen/10 p-6 rounded-xl border border-aquaGreen/20 hover:border-neonPink transition-all duration-300 group shadow-xl hover:shadow-neonPink/40 hover-glow">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-aquaGreen/10 flex items-center justify-center mr-4 border border-aquaGreen/20 backdrop-blur-sm">
                  <img alt="User avatar" src="/lovable-uploads/37fc9c35-03ad-474c-be10-708f44540309.png" className="w-full h-full rounded-full object-cover" />
                </div>
                <div>
                  <h4 className="font-semibold text-pureWhite">Mike Kim</h4>
                  <p className="text-aquaGreen/90 italic">Lead Engineer em <span className="text-electricBlue">V0</span></p>
                </div>
              </div>
              <p className="text-aquaGreen/90 italic">
